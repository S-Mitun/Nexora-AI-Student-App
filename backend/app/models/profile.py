...
class UserProfile(Base, TimestampMixin):
    ...
    grade_level: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, default=None)
    academic_domain: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, default=None)
    education_category: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, default=None)
